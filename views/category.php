<div class="container">
    <div class="card">
        <div class="card-header row">
            <h1 class="col-md-10">La liste des categories</h1>
            <div class="col-md-2">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php foreach($cats as $c): ?>
                        ...
                        <td><?= $c->tag ?></td>
                        <td>
                            <a href="?page=category&type=edit&id=<?= $c->id ?>" class="btn btn-info btn-sm"><i class="ti ti-edit"></i></a>
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="?page=category&idDeleting=<?= $c->id ?>"  class="btn btn-danger">Oui</a>
                                </div>
                                </div>
                            </div>
                            </div>
