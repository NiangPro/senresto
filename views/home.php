                    ...
                    <?php foreach($cats as $c): ?>
                        ...
                        <li class="nav-item">
                            <a class="d-flex align-items-center text-start mx-3 ms-0 pb-3 active" data-bs-toggle="pill" href="#tab-1">
                                ...
                                <div class="ps-3">
                                    <small class="text-body"><?= $c->tag ?></small>
                                    <h6 class="mt-n1 mb-0"><?= $c->nom ?></h6>
                                </div>
                            </a>
                        </li>
                    <?php endforeach; ?>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        <img class="flex-shrink-0 img-fluid rounded" src="images/<?= $p->image ?>" alt="" style="width: 80px;">
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span><?= $p->nom ?></span>
                                                <span class="text-primary"><?= $p->prix ?> FCFA</span>
                                            </h5>
